...
export default function Home() {
  ...
  return (
        <main className={styles.mainContainer}>
            ...
            <h1 className={darkMode ? "dark" : ""}>THE CONCEPT</h1>
            ...
            <div className={`${styles.appSection}`}>
                ...
                <div>
                    <h1 className={darkMode ? "dark" : ""}>THE APPLICATION</h1>
